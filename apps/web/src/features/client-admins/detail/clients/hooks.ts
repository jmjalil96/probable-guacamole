...
import type {
  UseClientAdminClientsTabReturn,
  ClientModalState,
  ClientModalHandlers,
  ClientRemoveState,
...
function useClientRemoveState(): UseClientRemoveStateReturn {
  ...
  const openRemove = useCallback((client: ClientAdminClient) => {
...
// =============================================================================
// useClientAdminClientsTab (Master Orchestration)
// =============================================================================
 ...
 */
export function useClientAdminClientsTab(clientAdminId: string): UseClientAdminClientsTabReturn {
  // ---------------------------------------------------------------------------
  // 1. Data Fetching
  // ---------------------------------------------------------------------------
  const { data, isLoading, isError, refetch } = useClientAdminClients(clientAdminId);
  ...
  const removeMutation = useRemoveClientAdminClient();
  ...
  }, [clientAdminId, removeModal, removeMutation]);
...
export function useAssignClientForm(
  ...
  // Mutation
  // ---------------------------------------------------------------------------
  const assignMutation = useAssignClientAdminClient();
  ...
  }, [clientAdminId, selectedClient, assignMutation, onSuccess]);
