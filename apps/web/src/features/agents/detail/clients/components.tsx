...
import { useAgentClientsTab, useAssignClientForm } from "./hooks";
import { clientColumns, clientColumnHelper } from "./columns";
import type {
  AgentClientsTabProps,
...
export function AssignClientModal({
  ...
  const form = useAssignClientForm(agentId, onClose);
    ...
    <Modal open={open} onClose={onClose}>
      <Modal.Panel size="md">
        <Modal.Header>
          ...
          <Modal.Description>
            Busque y seleccione un cliente para asignar a este agente.
          </Modal.Description>
        </Modal.Header>
...
// =============================================================================
// AgentClientsTab (Entry Point)
// =============================================================================

export function AgentClientsTab({ agentId }: AgentClientsTabProps) {
  const {
    clients,
    isLoading,
    isError,
